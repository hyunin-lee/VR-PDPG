...
def VR_PDPG(env,agent,previous_agent,agent_reference,args,num_states,num_actions,writer,save_foldername) :
    ...
    ## define variables
    target_occupancy_measure = get_target_occupancy_measure_20x20(num_states,num_actions,gamma)
...
if __name__ == '__main__':
    ...
    env = gym.make('FrozenLake-v1', desc=desc, map_name="20x20", is_slippery=False)
